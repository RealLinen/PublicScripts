--[[
    This is kavo UI lib, but modified to be undetected by most games [ This is not FULLY verified, but no bans were reported ]
    Modified by: Linen#3485
    Original Creator: https://v3rmillion.net/member.php?action=profile&uid=1347047
    Original Github: https://github.com/xHeptc/Kavo-UI-Library
...
local guiPath = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui",300)
